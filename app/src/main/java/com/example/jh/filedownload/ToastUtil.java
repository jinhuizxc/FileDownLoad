...
//     * 首页刷新的toast
//     */
//    public static Toast showRefreshToast(final String str){
//        if(toast3 == null){
//            toast3 = new Toast(BaseApplication.getAppContext());
//        }
//        View view = LayoutInflater.from(BaseApplication.getAppContext()).inflate(R.layout.toast_refresh,null);
//        TextView tv = (TextView) view.findViewById(R.id.tv_refresh_num);
//        tv.setText(str);
//        toast3.setView(view);
//        toast3.setGravity(Gravity.TOP| Gravity.CENTER_HORIZONTAL, 0, 280);
//        toast3.show();
//        return toast3;
//    }
}
